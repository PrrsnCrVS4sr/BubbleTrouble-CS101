...
public:
    Shooter(double position_x, double position_y, double vx_=300, double height=30, double width=18, double head_radius=8, Color color_=COLOR(0, 255, 0),int HP=5)
    {
        // Shooter constructor
        color = color_;
        hitPoints = HP;
    ...
    void  ChangeColourForAMoment(double seconds) // momentarily changes colour of the shooter once it collides with a bubble
    {
